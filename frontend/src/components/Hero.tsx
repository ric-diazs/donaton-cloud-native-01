     ...
     return(
        <section className="bg-navy min-h-[90vh] flex flex-col items-center justify-center text-center px-6 py-20 gap-8">
            ...
            <div className="flex items-center gap-2 bg-teal/10 border border-teal/30 px-4 py-2 rounded-full">
                ...
                <span className="text-teal text-sm font-medium">Coordinación humanitaria · Chile</span>
            </div>

            {/* Título principal con acento en teal */}
            <h1 className="text-white text-5xl md:text-6xl font-bold leading-tight max-w-3xl">Donaciones que llegan
                <br />
            ...
            >
            Donaton conecta donaciones con necesidades reales en tiempo real. Reducimos el desperdicio mediante trazabilidad digital, asegurando que cada aporte llegue a quien más lo necesita.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <button
                    // onClick={() => navigate('/donar')} // Descomentar al implementarlo
                    className="bg-teal text-navy font-semibold px-8 py-3.5 rounded-xl hover:bg-teal/90 transition-all duration-200 text-base cursor-pointer"
                >
                    Quiero donar
                </button>
                ...
                <button
                    onClick={() => navigate('/login')} // Descomentar al implementarlo
                    className="border border-white text-white font-semibold px-8 py-3.5 rounded-xl hover:bg-white/10 transition-all duration-200 text-base cursor-pointer"
                >
                    Ingresar al sistema
                </button>
            </div>
            ...
            <div className="absolute bottom-8 flex flex-col items-center gap-2 animate-bounce cursor-pointer">
